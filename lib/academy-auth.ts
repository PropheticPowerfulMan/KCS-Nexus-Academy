...
export type AcademyContext = { source:string; displayName:string; courses?:AcademyCourse[]; profile?:{id:string;studentNumber:string;grade:string;section:string}|null; population?:{students:number;parents:number;teachers:number;courses:number} };
